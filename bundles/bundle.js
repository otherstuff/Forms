...
/***/ function(module, exports, __webpack_require__) {
	...
	var _collectionsSnippets = __webpack_require__(5);
	
	var _collectionsSnippets2 = _interopRequireDefault(_collectionsSnippets);
	
	var _collectionsMyFormSnippets = __webpack_require__(44);
	
	var _collectionsMyFormSnippets2 = _interopRequireDefault(_collectionsMyFormSnippets);
	
	var _viewsTab = __webpack_require__(46);
	
	var _viewsTab2 = _interopRequireDefault(_viewsTab);
	
	var _viewsMyForm = __webpack_require__(47);
	
	var _viewsMyForm2 = _interopRequireDefault(_viewsMyForm);
	
	var _helperDb = __webpack_require__(48);
	
	var _dataInput = __webpack_require__(50);
	
	var _dataInput2 = _interopRequireDefault(_dataInput);
	
	var _dataRadio = __webpack_require__(51);
	
	var _dataRadio2 = _interopRequireDefault(_dataRadio);
	
	var _dataSelect = __webpack_require__(52);
	
	var _dataSelect2 = _interopRequireDefault(_dataSelect);
	
	var _dataButtons = __webpack_require__(53);
	
	var _dataButtons2 = _interopRequireDefault(_dataButtons);
	
	var _templatesTemplatesJs = __webpack_require__(9);
	
	exports['default'] = {
	  initialize: function initialize() {
	    //Bootstrap tabs from json.
	
	    new _viewsTab2['default']({
	      title: "Input",
	      collection: new _collectionsSnippets2['default'](_dataInput2['default'])
	    });
	    new _viewsTab2['default']({
	      title: "Radios / Checkboxes",
	      collection: new _collectionsSnippets2['default'](_dataRadio2['default'])
	    });
	    new _viewsTab2['default']({
	      title: "Select",
	      collection: new _collectionsSnippets2['default'](_dataSelect2['default'])
	    });
	    new _viewsTab2['default']({
	      title: "Buttons",
	      collection: new _collectionsSnippets2['default'](_dataButtons2['default'])
	    });
	    var renderView = new _viewsTab2['default']({
	      title: "Rendered",
	      content: _templatesTemplatesJs.render
	    });
	    new _viewsTab2['default']({
	      title: "Settings",
	      content: _templatesTemplatesJs.settings
	    });
	
	    //Make the first tab active!
	    (0, _jquery2['default'])("#components .tab-pane").first().addClass("active");
	    //$("#formtabs li").first().addClass("active");
	    (0, _jquery2['default'])("#formtabs li a").first().addClass("active");
	    // Bootstrap "My Form" with 'Form Name' snippet.
	    var formView = new _viewsMyForm2['default']({
	      title: "Original",
	      collection: new _collectionsMyFormSnippets2['default']([{ "title": "Form Name",
	        "fields": {
	          "name": {
	            "label": "Form Name",
	            "type": "input",
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _modelsSnippet = __webpack_require__(6);
	
	var _modelsSnippet2 = _interopRequireDefault(_modelsSnippet);
	
	var _viewsTabSnippet = __webpack_require__(7);
	
	var _viewsTabSnippet2 = _interopRequireDefault(_viewsTabSnippet);
	
	exports['default'] = _backbone2['default'].Collection.extend({
	  model: _modelsSnippet2['default'],
	  renderAll: function renderAll() {
	    return this.map(function (snippet) {
	      return new _viewsTabSnippet2['default']({ model: snippet }).render();
	    });
	  }
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _backbone2['default'].Model.extend({
	  ...
	  getValues: function getValues() {
	    return _underscore2['default'].reduce(this.get("fields"), function (o, v, k) {
	      if (v["type"] == "select") {
	        o[k] = _underscore2['default'].find(v["value"], function (o) {
	          return o.selected;
	        })["value"];
	      } else {
	        o[k] = v["value"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tempSnippet = __webpack_require__(8);
	
	var _tempSnippet2 = _interopRequireDefault(_tempSnippet);
	
	var _helperPubsub = __webpack_require__(40);
	
	var _helperPubsub2 = _interopRequireDefault(_helperPubsub);
	
	var _snippet = __webpack_require__(41);
	
	var _snippet2 = _interopRequireDefault(_snippet);
	
	exports['default'] = _snippet2['default'].extend({
	  events: {
	  ...
	  mouseDownHandler: function mouseDownHandler(mouseDownEvent) {
	    ...
	    //hide all popovers
	    (0, _jquery2['default'])(".popover").hide();
	    (0, _jquery2['default'])("body").append(new _tempSnippet2['default']({ model: new _modelsSnippet2['default'](_jquery2['default'].extend(true, {}, this.model.attributes)) }).render());
	    _helperPubsub2['default'].trigger("newTempPostRender", mouseDownEvent);
	  }
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _templatesTemplates = __webpack_require__(9);
	...
	exports['default'] = _snippet2['default'].extend({
	  initialize: function initialize() {
	    _helperPubsub2['default'].on("newTempPostRender", this.postRender, this);
	    this.constructor.__super__.initialize.call(this);
	    this.tempTemplate = _underscore2['default'].template(_templatesTemplates.temp);
	  },
	  className: "temp",
	  ...
	  centerOnEvent: function centerOnEvent(mouseEvent) {
	    ...
	    _helperPubsub2['default'].trigger("tempMove", mouseEvent);
	  },
	  ...
	  mouseUpHandler: function mouseUpHandler(mouseEvent) {
	    mouseEvent.preventDefault();
	    _helperPubsub2['default'].trigger("tempDrop", mouseEvent, this.model);
	    this.remove();
	  }
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appSettings = __webpack_require__(10);
	
	var _appSettings2 = _interopRequireDefault(_appSettings);
	
	var _appRender = __webpack_require__(11);
	
	var _appRender2 = _interopRequireDefault(_appRender);
	
	var _appRenderform = __webpack_require__(12);
	
	var _appRenderform2 = _interopRequireDefault(_appRenderform);
	
	var _appTabNav = __webpack_require__(13);
	
	var _appTabNav2 = _interopRequireDefault(_appTabNav);
	
	var _appTemp = __webpack_require__(14);
	
	var _appTemp2 = _interopRequireDefault(_appTemp);
	
	var _popoverPopoverCheckbox = __webpack_require__(15);
	
	var _popoverPopoverCheckbox2 = _interopRequireDefault(_popoverPopoverCheckbox);
	
	var _popoverPopoverInput = __webpack_require__(16);
	
	var _popoverPopoverInput2 = _interopRequireDefault(_popoverPopoverInput);
	
	var _popoverPopoverMain = __webpack_require__(17);
	
	var _popoverPopoverMain2 = _interopRequireDefault(_popoverPopoverMain);
	
	var _popoverPopoverSelect = __webpack_require__(18);
	
	var _popoverPopoverSelect2 = _interopRequireDefault(_popoverPopoverSelect);
	
	var _popoverPopoverTextareaSplit = __webpack_require__(19);
	
	var _popoverPopoverTextareaSplit2 = _interopRequireDefault(_popoverPopoverTextareaSplit);
	
	var _popoverPopoverTextarea = __webpack_require__(20);
	
	var _popoverPopoverTextarea2 = _interopRequireDefault(_popoverPopoverTextarea);
	
	var _snippetAppendedcheckbox = __webpack_require__(21);
	
	var _snippetAppendedcheckbox2 = _interopRequireDefault(_snippetAppendedcheckbox);
	
	var _snippetAppendedtext = __webpack_require__(22);
	
	var _snippetAppendedtext2 = _interopRequireDefault(_snippetAppendedtext);
	
	var _snippetButton = __webpack_require__(23);
	
	var _snippetButton2 = _interopRequireDefault(_snippetButton);
	
	var _snippetButtondouble = __webpack_require__(24);
	
	var _snippetButtondouble2 = _interopRequireDefault(_snippetButtondouble);
	
	var _snippetButtondropdown = __webpack_require__(25);
	
	var _snippetButtondropdown2 = _interopRequireDefault(_snippetButtondropdown);
	
	var _snippetFilebutton = __webpack_require__(26);
	
	var _snippetFilebutton2 = _interopRequireDefault(_snippetFilebutton);
	
	var _snippetFormname = __webpack_require__(27);
	
	var _snippetFormname2 = _interopRequireDefault(_snippetFormname);
	
	var _snippetMultiplecheckboxes = __webpack_require__(28);
	
	var _snippetMultiplecheckboxes2 = _interopRequireDefault(_snippetMultiplecheckboxes);
	
	var _snippetMultiplecheckboxesinline = __webpack_require__(29);
	
	var _snippetMultiplecheckboxesinline2 = _interopRequireDefault(_snippetMultiplecheckboxesinline);
	
	var _snippetMultipleradios = __webpack_require__(30);
	
	var _snippetMultipleradios2 = _interopRequireDefault(_snippetMultipleradios);
	
	var _snippetMultipleradiosinline = __webpack_require__(31);
	
	var _snippetMultipleradiosinline2 = _interopRequireDefault(_snippetMultipleradiosinline);
	
	var _snippetPasswordinput = __webpack_require__(32);
	
	var _snippetPasswordinput2 = _interopRequireDefault(_snippetPasswordinput);
	
	var _snippetPrependedcheckbox = __webpack_require__(33);
	
	var _snippetPrependedcheckbox2 = _interopRequireDefault(_snippetPrependedcheckbox);
	
	var _snippetPrependedtext = __webpack_require__(34);
	
	var _snippetPrependedtext2 = _interopRequireDefault(_snippetPrependedtext);
	
	var _snippetSearchinput = __webpack_require__(35);
	
	var _snippetSearchinput2 = _interopRequireDefault(_snippetSearchinput);
	
	var _snippetSelectbasic = __webpack_require__(36);
	
	var _snippetSelectbasic2 = _interopRequireDefault(_snippetSelectbasic);
	
	var _snippetSelectmultiple = __webpack_require__(37);
	
	var _snippetSelectmultiple2 = _interopRequireDefault(_snippetSelectmultiple);
	
	//import snippetTemplates from './snippet/snippet-templates';
	
	var _snippetTextarea = __webpack_require__(38);
	
	var _snippetTextarea2 = _interopRequireDefault(_snippetTextarea);
	
	var _snippetTextinput = __webpack_require__(39);
	
	var _snippetTextinput2 = _interopRequireDefault(_snippetTextinput);
	
	var _templates = __webpack_require__(9);
	
	var _templates2 = _interopRequireDefault(_templates);
	
	exports.settings = _appSettings2['default'];
	exports.render = _appRender2['default'];
	exports.renderform = _appRenderform2['default'];
	exports.nav = _appTabNav2['default'];
	exports.temp = _appTemp2['default'];
	exports.popoverCheckbox = _popoverPopoverCheckbox2['default'];
	exports.popoverInput = _popoverPopoverInput2['default'];
	exports.popoverMain = _popoverPopoverMain2['default'];
	exports.popoverSelect = _popoverPopoverSelect2['default'];
	exports.popoverTextareaSplit = _popoverPopoverTextareaSplit2['default'];
	exports.popoverTextarea = _popoverPopoverTextarea2['default'];
	exports.appendedcheckbox = _snippetAppendedcheckbox2['default'];
	exports.appendedtext = _snippetAppendedtext2['default'];
	exports.singlebutton = _snippetButton2['default'];
	exports.doublebutton = _snippetButtondouble2['default'];
	exports.buttondropdown = _snippetButtondropdown2['default'];
	exports.filebutton = _snippetFilebutton2['default'];
	exports.formname = _snippetFormname2['default'];
	exports.multiplecheckboxes = _snippetMultiplecheckboxes2['default'];
	exports.multiplecheckboxesinline = _snippetMultiplecheckboxesinline2['default'];
	exports.multipleradios = _snippetMultipleradios2['default'];
	exports.multipleradiosinline = _snippetMultipleradiosinline2['default'];
	exports.passwordinput = _snippetPasswordinput2['default'];
	exports.prependedcheckbox = _snippetPrependedcheckbox2['default'];
	exports.prependedtext = _snippetPrependedtext2['default'];
	exports.searchinput = _snippetSearchinput2['default'];
	exports.selectbasic = _snippetSelectbasic2['default'];
	exports.selectmultiple = _snippetSelectmultiple2['default'];
	
	//export {snippetTemplates as snippetTemplates};
	exports.textarea = _snippetTextarea2['default'];
	exports.textinput = _snippetTextinput2['default'];
...
/***/ function(module, exports) {
	...
	exports["default"] = "<h3>Settings</h3>\n\n<p>\nsettings go here!\n</p>";
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	exports["default"] = "<h3>Rendered source of your form:</h3>\n<textarea id=\"render\" class=\"span6\"></textarea>";
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	exports["default"] = "<form class=\"form-horizontal\" <% if(multipart){ %>enctype=\"multipart/form-data\"<% } %>>\n<fieldset>\n\n<%= text %>\n</fieldset>\n</form>";
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	exports["default"] = "<li class=\"nav-item\"><a class=\"nav-link\" href=\"#<%= id %>\" data-toggle=\"tab\"><%= title %></a></li>";
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	exports["default"] = "<!-- Multiple Checkboxes (inline) -->\n<div class=\"control-group\">\n  <label class=\"control-label\" for=\"<%- name %>\"><%- label %></label>\n  <div class=\"controls\"><% _.each(checkboxes, function(checkbox, i){ %>\n    <label class=\"checkbox inline\" for=\"<%- id+'-'+i %>\">\n      <input type=\"checkbox\" name=\"<%- id %>\" id=\"<%- id+'-'+i %>\" value=\"<%- checkbox %>\"<% if(required){ %> required=\"required\"<% } %>>\n      <%- checkbox %>\n    </label><% }); %>\n  </div>\n</div>";
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	exports["default"] = "<!-- Multiple Radios (inline) -->\n<div class=\"control-group\">\n  <label class=\"control-label\" for=\"<%- name %>\"><%- label %></label>\n  <div class=\"controls\"><% _.each(radios, function(radio, i){ %>\n    <label class=\"radio inline\" for=\"<%- id+'-'+i %>\">\n      <input type=\"radio\" name=\"<%- id %>\" id=\"<%- id+'-'+i %>\" value=\"<%- radio %>\" <% if(i < 1) { %>checked=\"checked\" <% } %><% if(required){ %> required=\"required\"<% } %>>\n      <%- radio %>\n    </label><% }); %>\n  </div>\n</div>";
	module.exports = exports["default"];
...
/***/ function(module, exports) {
	...
	exports["default"] = "<!-- Prepended text-->\n<div class=\"control-group\">\n  <label class=\"control-label\" for=\"<%- id %>\"><%- label %></label>\n  <div class=\"controls\">\n    <div class=\"input-prepend\">\n      <span class=\"add-on\"><%- prepend %></span>\n      <input id=\"<%- id %>\" name=\"<%- id %>\" class=\"<%- inputsize %>\" placeholder=\"<%- placeholder %>\" type=\"text\"<% if(required) {%> required <% } %> />\n    </div>\n    <% if (helptext.length > 0) { %><p class=\"help-block\"><%- helptext %></p><% } %>\n  </div>\n</div>";
	module.exports = exports["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tether = __webpack_require__(42);
	...
	var _templatesTemplates = __webpack_require__(
	//snippetTemplates as _snippetTemplates
	9);
	
	var _snippetTemplates = _interopRequireWildcard(_templatesTemplates);
	
	exports['default'] = _backbone2['default'].View.extend({
	  tagName: "div",
	  className: "component",
	  initialize: function initialize() {
	    this.template = _underscore2['default'].template(_snippetTemplates[this.model.idFriendlyTitle()]);
	    this.popoverTemplates = {
	      "input": _underscore2['default'].template(_templatesTemplates.popoverInput),
	      "select": _underscore2['default'].template(_templatesTemplates.popoverSelect),
	      "textarea": _underscore2['default'].template(_templatesTemplates.popoverTextarea),
	      "textarea-split": _underscore2['default'].template(_templatesTemplates.popoverTextareaSplit),
	      "checkbox": _underscore2['default'].template(_templatesTemplates.popoverCheckbox)
	    };
	  },
	  render: function render(withAttributes) {
	    var that = this;
	    var content = _underscore2['default'].template(_templatesTemplates.popoverMain)({
	      "title": that.model.get("title"),
	      "items": that.model.get("fields"),
	      "popoverTemplates": that.popoverTemplates
	    });
	    if (withAttributes) {
	      return this.$el.html(that.template(that.model.getValues())).attr({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Tether = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _snippets = __webpack_require__(5);
	
	var _snippets2 = _interopRequireDefault(_snippets);
	
	var _viewsMyFormSnippet = __webpack_require__(45);
	
	var _viewsMyFormSnippet2 = _interopRequireDefault(_viewsMyFormSnippet);
	
	exports['default'] = _snippets2['default'].extend({
	  model: _modelsSnippet2['default'],
	  initialize: function initialize() {
	    this.counter = {};
	  ...
	  giveUniqueId: function giveUniqueId(snippet) {
	  ...
	  containsFileType: function containsFileType() {
	  ...
	  renderAll: function renderAll() {
	    return this.map(function (snippet) {
	      return new _viewsMyFormSnippet2['default']({ model: snippet }).render(true);
	    });
	  },
	  renderAllClean: function renderAllClean() {
	    return this.map(function (snippet) {
	      return new _viewsMyFormSnippet2['default']({ model: snippet }).render(false);
	    });
	  }
	});
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _snippet2['default'].extend({
	  ...
	  mouseDownHandler: function mouseDownHandler(mouseDownEvent) {
	    ...
	    (0, _jquery2['default'])(".popover #save").on("click", this.saveHandler(that));
	    (0, _jquery2['default'])(".popover #cancel").on("click", this.cancelHandler(that));
	    //add drag event for all but form name
	    if (this.model.get("title") !== "Form Name") {
	      (0, _jquery2['default'])("body").on("mousemove", function (mouseMoveEvent) {
	        if (Math.abs(mouseDownEvent.pageX - mouseMoveEvent.pageX) > 10 || Math.abs(mouseDownEvent.pageY - mouseMoveEvent.pageY) > 10) {
	          ...
	          _helperPubsub2['default'].trigger("mySnippetDrag", mouseDownEvent, that.model);
	          that.mouseUpHandler();
	        };
	      });
	    }
	  ...
	  mouseUpHandler: function mouseUpHandler(mouseUpEvent) {
	    (0, _jquery2['default'])("body").off("mousemove");
	  },
	
	  saveHandler: function saveHandler(boundContext) {
	    return function (mouseEvent) {
	      mouseEvent.preventDefault();
	      var fields = (0, _jquery2['default'])(".popover .field");
	      _underscore2['default'].each(fields, function (e) {
	        ...
	        switch (type) {
	          ...
	          case "textarea":
	            ...
	            break;
	          case "textarea-split":
	            boundContext.model.setField(name, _underscore2['default'].chain($e.val().split("\n")).map(function (t) {
	              return _jquery2['default'].trim(t);
	            }).filter(function (t) {
	              return t.length > 0;
	            }).value());
	            break;
	          case "select":
	            var valarr = _underscore2['default'].map($e.find("option"), function (e) {
	              return { value: e.value, selected: e.selected, label: (0, _jquery2['default'])(e).text() };
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _backbone2['default'].View.extend({
	  ...
	  initialize: function initialize() {
	    ...
	    this.tabNavTemplate = _underscore2['default'].template(_templatesTemplates.nav);
	    this.render();
	  },
	  render: function render() {
	    ...
	    if (that.collection !== undefined) {
	      _underscore2['default'].each(this.collection.renderAll(), function (snippet) {
	    ...
	    (0, _jquery2['default'])("#formtabs").append(this.tabNavTemplate({ title: this.options.title, id: this.id }));
	    // Render tab
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports['default'] = _backbone2['default'].View.extend({
	  ...
	  initialize: function initialize() {
	    ...
	    _helperPubsub2['default'].on("mySnippetDrag", this.handleSnippetDrag, this);
	    _helperPubsub2['default'].on("tempMove", this.handleTempMove, this);
	    _helperPubsub2['default'].on("tempDrop", this.handleTempDrop, this);
	    this.$build = (0, _jquery2['default'])("#build");
	    this.renderForm = _underscore2['default'].template(_templatesTemplates.renderform);
	    this.formMarkup = '';
	    this.render();
	  },
	  ...
	  render: function render() {
	    ...
	    this.formMarkup = _underscore2['default'].map(this.collection.renderAllClean(), function (e) {
	      return e.html();
	    }).join('\n');
	    (0, _jquery2['default'])("#render").val(that.renderForm({
	  ...
	  getBottomAbove: function getBottomAbove(eventY) {
	    var myFormBits = (0, _jquery2['default'])(this.$el.find(".component"));
	    var topelement = _underscore2['default'].find(myFormBits, function (renderedSnippet) {
	      if ((0, _jquery2['default'])(renderedSnippet).offset().top + (0, _jquery2['default'])(renderedSnippet).height() > eventY - 90) {
	        return true;
	      } else {
	        return false;
	      }
	  ...
	  handleSnippetDrag: function handleSnippetDrag(mouseEvent, snippetModel) {
	    (0, _jquery2['default'])("body").append(new _tempSnippet2['default']({ model: snippetModel }).render());
	    this.collection.remove(snippetModel);
	    _helperPubsub2['default'].trigger("newTempPostRender", mouseEvent);
	  },
	
	  handleTempMove: function handleTempMove(mouseEvent) {
	    (0, _jquery2['default'])(".target").removeClass("target");
	    if (mouseEvent.pageX >= this.$build.offset().left && mouseEvent.pageX < this.$build.width() + this.$build.offset().left && mouseEvent.pageY >= this.$build.offset().top && mouseEvent.pageY < this.$build.height() + this.$build.offset().top) {
	      (0, _jquery2['default'])(this.getBottomAbove(mouseEvent.pageY)).addClass("target");
	    } else {
	      (0, _jquery2['default'])(".target").removeClass("target");
	    }
	  },
	
	  handleTempDrop: function handleTempDrop(mouseEvent, model, index) {
	    if (mouseEvent.pageX >= this.$build.offset().left && mouseEvent.pageX < this.$build.width() + this.$build.offset().left && mouseEvent.pageY >= this.$build.offset().top && mouseEvent.pageY < this.$build.height() + this.$build.offset().top) {
	      var index = (0, _jquery2['default'])(".target").index();
	      (0, _jquery2['default'])(".target").removeClass("target");
	...
	exports["default"] = [{
	  ...
	  "fields": {
	    ...
	    "buttonoptions": {
	      "label": "Options",
	      "type": "textarea-split",
	      "value": ["Option one", "Option two", "Option three"]
	    },
	    "required": {
	      "label": "Required",
	      "type": "checkbox",
